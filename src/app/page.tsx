...
function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "studio" | "pricing" | "quotes" | "admin"
  >("overview");
        ...
        <main className="p-8 max-w-7xl w-full mx-auto space-y-8">
          ...
          <div className="flex justify-between items-end flex-wrap gap-4">
            <div>
              ...
              <p className="text-sm text-[#6B6459] mt-1">
                Hệ thống vận hành Sơn Hiệu Ứng Việt · Kết nối Supabase
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <Card hoverable>
              ...
              <div className="text-3xl font-serif font-bold text-[#1C2321] mt-2">
                12
              </div>
              <div className="text-xs text-[#5B6B4F] mt-1.5 font-medium">
                trên tổng 18 dự án
              </div>
            </Card>
            ...
            <Card hoverable>
              ...
              <div className="text-xs text-[#B8862B] mt-1.5 font-medium">
                Cần Kỹ thuật / Quản lý duyệt
              </div>
            </Card>
            ...
            <Card hoverable>
              ...
              <div className="text-xs text-[#6B6459] mt-1.5 font-medium">
                Chờ phản hồi từ khách
              </div>
            </Card>
            ...
            <Card hoverable>
              ...
              <div className="text-2xl font-serif font-bold text-[#A6592C] mt-2">
                142.500.000 đ
              </div>
              <div className="text-xs text-[#5B6B4F] mt-1.5 font-medium">
                Tháng này
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-bold font-serif text-[#1C2321]">
                Công trình tiến độ mới nhất
              </h2>
                ...
                <tbody className="divide-y divide-[#F0EBE1]">
                  <tr className="hover:bg-[#FAF7F2] transition-colors cursor-pointer">
                    ...
                    <td className="p-3.5 font-semibold">
                      Biệt thự mặt tiền - Trần Phú
                    </td>
                    <td className="p-3.5">Nguyễn Văn Long</td>
                    <td className="p-3.5">
                      <Badge variant="dim">Ngoại thất</Badge>
                    </td>
                    <td className="p-3.5">
                      <Badge variant="ochre">Chờ duyệt AI render</Badge>
                    </td>
                  </tr>
                  <tr className="hover:bg-[#FAF7F2] transition-colors cursor-pointer">
                    ...
                    <td className="p-3.5">
                      <Badge variant="dim">Nội thất</Badge>
                    </td>
                    <td className="p-3.5">
                      <Badge variant="copper">Đã gửi báo giá</Badge>
                    </td>
                  </tr>
                  <tr className="hover:bg-[#FAF7F2] transition-colors cursor-pointer">
                    <td className="p-3.5 font-mono text-xs">CT-2026-000003</td>
                    <td className="p-3.5 font-semibold">
                      Tường rào biệt thự sân vườn
                    </td>
                    <td className="p-3.5">Nguyễn Văn Long</td>
                    <td className="p-3.5">
                      <Badge variant="dim">Ngoại thất</Badge>
                    ...
                    <td className="p-3.5">
                      <Badge variant="sage">Khách đã chốt</Badge>
                    </td>
                  </tr>
                </tbody>
              </table>
